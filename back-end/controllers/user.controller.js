...
const updateUserProfile = async (req, res) => {
    try {
        ...
        const allowedUpdates = ['username', 'displayName', 'gender', 'dateOfBirth', 'phone', 'avatarUrl', 'bio', 'location'];
...
const followUser = async (req, res) => {
    try {
        ...
        await redisClient.del(`user:${userId}:following`); // Invalidate following cache
        await redisClient.del(`user:${targetUserId}:followers`); // Invalidate followers cache
